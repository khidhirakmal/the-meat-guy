...
import { addNewAddressFormControls } from "@/components/utilities";
...
export default function Account() {
  ...
  return (
    <section>
      <div className="text-black mx-auto bg-gray-100 px-4 sm:px-6 lg:px-8">
        <div className="bg-white shadow">
          <div className="p-6 sm:p-12">
            <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
              <h1 className="font-bold text-lg mb-2">Personal Details</h1>
              {/* Render random user image here */}
            </div>
            <div className="flex flex-col flex-1 border px-5 py-3">
            ...
            <button
              ...
              className="mt-5  inline-block bg-black text-white px-5 py-3 text-xs font-medium uppercase tracking-wide hover:bg-neutral-800 hover:font-extrabold rounded"
            >
              View Your Orders
            </button>
            <div className="mt-6">
